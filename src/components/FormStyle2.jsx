...
const FormStyle2 = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 to-gray-950 text-white p-6 rounded-xl space-y-6 shadow-inner">
      <div className="flex justify-center">
        {image ? (
          <img src={URL.createObjectURL(image)} alt="Preview" className="w-[28%] max-h-[300px] object-contain border border-purple-500" />
        ) : (
          <div className="w-[28%] h-[300px] border border-purple-500 rounded-xl flex items-center justify-center text-gray-500">No Image</div>
        )}
      </div>
